...
<div class="container ">
    <div class="d-flex justify-content-around">
        <div class="card col-sm-11 m-0 p-0 separadorwilly">
            ...
            <div class="card-body">
                <p class="m-4 text-justify col-sm-11 ">
                ...
                <form method="post" class="needs-validation"  action="guardar_evidencia2025-1.php" enctype="multipart/form-data" novalidate>
                   ...
                   <!-- Aquí va los datos del entrevistador --> 
                    ...
                    <div class="m-3 row text-start"><b>Datos del entrevistador </b></div> 
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-2 col-form-label text-start"  for="validationCustom00">Nombres y Apellidos:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="validationCustom00" minlength="2" name="Entrevistador"  required>
                             <div class="col-sm-3 valid-feedback">
                                Correcto!
                            </div>
                            <div class="col-sm-3 invalid-feedback">
                                ¡Ingrese sus datos!
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="m-3 row text-start"><b>I. Datos del entrevistado</b></div>
                    <div class="m-3 row form-group row col-sm-12 col-md-12">
                        <label class="col-sm-2 col-form-label text-start" for="validationCustom00">Programa:</label>
                        <div class="col-sm-9">
                            <select class="form-select" name="programa" id="validationCustom00" required>
                    ...
                    <div class=" m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-2 col-form-label text-start" for="validationCustom01">Nombres:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-2 col-form-label text-start" for="validationCustom02">Apellidos:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="m-3 row text-start"><b>II. Guía de entrevista de admisión</b>
                    <p class="m-3 row text-start">
                    ...
                    <br>
                    <div class="m-3 row text-start"><b>Motivación para el estudio, conocimientos básicos e interés por desarrollar habilidades.</b></div>

                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label id="changeData1" class="col-sm-9 col-md-8 col-form-label text-start" for="inlineRadio1">
                    ...
                    <div class=" m-3 form-group row col-sm-12 col-md-12">
                        <label id="changeData2" class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio2">
                    ...
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label id="changeData3" class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio3">
                    ...
                    <div class="m-3 row text-start"><b>Interés por la investigación</b></div>

                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio4">
                    ...
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio5">
                    ...
                    <div class="m-3 row text-start"><b>Habilidades sociales y de comunicación aceptables</b></div>
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio6">
                    ...
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio7">
                    ...
                    <div class="m-3 row text-start"><b>Práctica de valores cristianos, vocación de servicio y empatía</b></div>
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio8">
                    ...
                    <div class="m-3 row text-start"><b>Salud física y mental</b></div>
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio9">
                    ...
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                        <label class="col-sm-12 col-md-8 col-form-label text-start" for="inlineRadio10">
                    ...
                    <div class="m-3 row text-start"><b>III. Observaciones</b></div>
                    <div class="m-3 form-group row col-sm-12 col-md-12">
                    <label class="col-sm-10 col-form-label text-start" for="validationCustom03">Escriba las observaciones que tenga:</label>
                        <div class="col-sm-12">
                    ...
                    <strong><i class="ml-6">Puntaje Global: </i><strong><input  id= "scor" type="text" name="SUMA" disabled / >        
...
$(document).ready(function () {
    ...
    function () {
        ...
        if (this.value = "Maestría en Nutrición Humana con Mención en Alimentación Basada en Plantas, Semipresencial") {
            $('#changeData1').text("¿Qué le motiva a estudiar la esta maestría?");
