    ...
    <div class="row text-center">
        <div class="card col-sm-12 m-0 p-0 separadorwilly">
            <div class="card-header">
                <h3 class="h1willy">Formulario de entrevista Nutrición: UPG Ciencias de la Salud</h3>
            ...
            <div class="card-body">
                ...
                <form method="post" class="needs-validation"  action="guardar_evidencia2025-1.php" enctype="multipart/form-data" novalidate>
                    ...
                    <div class = "form-group row col-sm-12 col-md-12">
                        <label class="col-sm-2 col-form-label text-left">Nombres y Apellidos:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="validationCustom00" minlength="5" name="Entrevistador" required>
                    ...
                    <div class="form-group row col-sm-12 col-md-12">
                        ...
                        <div class="col-sm-10">
                            <select class="custom-select" name="programa" id="validationCustom00" required>
                    ...
                    <strong><i>Puntaje Global: </i><strong><input id="score" type="text" name="SUMA" disabled / >        
